...
country_codes <- read.table("https://raw.githubusercontent.com/eolamijuwon/TidyTuesday/master/migration_flows_ZA/country_codes.csv", 
                           sep = ",", header=TRUE) %>% 
                dplyr::select(-c("X"))

## Geo-Location Data Obtained from
## https://developers.google.com/public-data/docs/canonical/countries_csv
location_data <- read.table("https://raw.githubusercontent.com/eolamijuwon/TidyTuesday/master/migration_flows_ZA/location_data.csv", 
                            sep = ",", header=TRUE) %>% 
                            dplyr::select(-c("X"))
